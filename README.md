...
| `2017`   | `ICLR` | [Pruning Filters for Efficient ConvNets](https://openreview.net/forum?id=rJqFGTslg) | `S` | [PyTorch (O)](https://paperswithcode.com/paper/pruning-filters-for-efficient-convnets) |
