...
| `2019`   | `CVPR`  | [Importance Estimation for Neural Network Pruning](https://openaccess.thecvf.com/content_CVPR_2019/html/Molchanov_Importance_Estimation_for_Neural_Network_Pruning_CVPR_2019_paper.html) | `S` | [PyTorch[O]](https://github.com/naveen-chander/importance-estimation-neural-pruning) |
...
| `2021`   | [IEEE Trans. PAMI](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=34)  | [Discrimination-Aware Network Pruning for Deep Model Compression](https://ieeexplore.ieee.org/document/9748003) | `S` | [PyTorch[A]~](https://github.com/SCUT-AILab/DCP)|
